...
void sparse_vec(vector<float>& vec, const float n)
{
	...
	static std::uniform_real_distribution<> dis1(-1, 1);
	static std::uniform_int_distribution<> dis2(0, vec.size() - 1);
...
void sparse_vec_binary(vector<float>& vec, const float n)
{
	vec_fill(vec, 0.0f);
	static std::default_random_engine e;
	static std::uniform_real_distribution<> dis1(-1, 1);
...
void sparse_vec_binary(vector<double>& vec, const float n)
{
	static std::default_random_engine e;
	static std::uniform_int_distribution<> dis1(-1, 1);
	static std::uniform_int_distribution<> dis2(0, vec.size() - 1);
